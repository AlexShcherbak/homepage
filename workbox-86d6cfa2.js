define("./workbox-86d6cfa2.js", ["exports"], (function (t) {
    ...
    class L {
        ...
        async cachePut(t, e) {
            ...
            if (!a) return !1;
            const {cacheName: h, matchOptions: u} = this.l, l = await self.caches.open(h),
                f = this.hasCallback("cacheDidUpdate"), w = f ? await async function (t, e, s, n) {
                    const i = m(e.url, s);
    ...
    class b extends class {
        ...
        async q(t, e, n) {
            ...
            try {
                ...
                for (const r of t.iterateCallbacks("handlerDidError")) if (i = await r({
                    error: s,
                    event: n,
                    request: e
                }), i) break;
    ...
    b.defaultPrecacheCacheabilityPlugin = {cacheWillUpdate: async ({response: t}) => !t || t.status >= 400 ? null : t}, b.copyRedirectedCacheableResponsesPlugin = {cacheWillUpdate: async ({response: t}) => t.redirected ? await R(t) : t};
